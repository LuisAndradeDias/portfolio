function scopoColor() {
    ...
    let afterAboutMe = document.querySelector(".about-me-title");
    let afterLanguage = document.querySelector(".language-title");
    
    if (colorAraay[numberColor] === '#3182ce') {
        afterAboutMe.classList.add('about-me-title-blue');
        afterAboutMe.classList.remove('about-me-title-purple');
        afterAboutMe.classList.remove('about-me-title-green');
        afterAboutMe.classList.remove('about-me-title-pink');

        afterLanguage.classList.add('language-title-blue');
        afterLanguage.classList.remove('language-title-purple');
        afterLanguage.classList.remove('language-title-green');
        afterLanguage.classList.remove('language-title-pink');
    }
    if (colorAraay[numberColor] === '#9f7aea') {
        afterAboutMe.classList.remove('about-me-title-blue');
        afterAboutMe.classList.add('about-me-title-purple');
        afterAboutMe.classList.remove('about-me-title-green');
        afterAboutMe.classList.remove('about-me-title-pink');

        afterLanguage.classList.remove('language-title-blue');
        afterLanguage.classList.add('language-title-purple');
        afterLanguage.classList.remove('language-title-green');
        afterLanguage.classList.remove('language-title-pink');
    }
    if (colorAraay[numberColor] === '#48bb78') {
        afterAboutMe.classList.remove('about-me-title-blue');
        afterAboutMe.classList.remove('about-me-title-purple');
        afterAboutMe.classList.add('about-me-title-green');
        afterAboutMe.classList.remove('about-me-title-pink');

        afterLanguage.classList.remove('language-title-blue');
        afterLanguage.classList.remove('language-title-purple');
        afterLanguage.classList.add('language-title-green');
        afterLanguage.classList.remove('language-title-pink');
    }
    if (colorAraay[numberColor] === '#ed64a6') {
        ...
        afterAboutMe.classList.remove('about-me-title-purple');
        afterAboutMe.classList.remove('about-me-title-green');
        afterAboutMe.classList.add('about-me-title-pink');

        afterLanguage.classList.remove('language-title-blue');
        afterLanguage.classList.remove('language-title-purple');
        afterLanguage.classList.remove('language-title-green');
        afterLanguage.classList.add('language-title-pink');
    }
